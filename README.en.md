...
**v3 or v2?** For new integrations use v3 (`#include "trtc_asr/v3.h"`): only SdkAppID + SecretKey, a cleaner protocol, and `Start()` throws auth/parameter errors — provided `EnableV3Route` is enabled for your SdkAppID. Existing v2 users can stay as they are.
